package test.poja.first.endpoint.rest.controller.health;

import static java.io.File.createTempFile;
import static test.poja.first.endpoint.rest.controller.health.PingController.OK;
...
import test.poja.first.mail.Email;
import test.poja.first.mail.Mailer;
